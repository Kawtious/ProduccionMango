...
subtitle: "Trabajo final Estadística aplicada ITSON (ISW)"
...
![Papas](https://agriculture.basf.com/mx/images/Proteccion%20de%20Cultivos/Cultivos/Papa/MX-cultivo-papa.jpg)

En este documento se llevará a cabo un análisis basado en datos con relación a la agricultura en el estado de Sonora, en donde se tocarán parámetros como el rendimiento anual, 
...
library(pacman)
p_load(ggplot2,readr,readxl,plotly,xfun,rmdformats,dplyr,MASS, class,GGally,psych,lmtest,corrplot,car, viridis, gridExtra,gganimate,magick)
```
...
1.    [SEMARNAT](http://dgeiawf.semarnat.gob.mx:8080/ibi_apps/WFServlet?IBIF_ex=D3_AGUA01_01&IBIC_user=dgeia_mce&IBIC_pass=dgeia_mce&NOMBREENTIDAD=*&NOMBREANIO=*)
2.    [SIAP](https://nube.siap.gob.mx/cierreagricola/)
...
Se puede apreciar, que la mayoría de los valores estar cerca a la linea de confianza, esto significa que estos datos están muy acercados a la realidad, esto significa que podemos trabajar con estos datos sin ningún miedo a cometer errores o algún **p-hacking** (Alterar los resultados para favorecer la hipótesis)
...
#### Linea de tiempo sobre las lluvias al paso del tiempo
...
Para una mejor interpretación de las gráficas, se acomodarán las 3 gráficas dentro de un solo cuadro, de esta manera se verá mas claro el significado de estas, y se podrá sacar una conclusión.
