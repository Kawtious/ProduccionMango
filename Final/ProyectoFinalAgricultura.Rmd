...
* ¿Qué pasaría si en vez de sembrar Maíz y trigo como se hace tanto se sembrara tanto de uva o de espárrago ?
...
```{r}
prodTotNacional <- read_xlsx("~/GitHub/ProduccionMango/Final/Datos por estado/Cultivos/ProduccionTotalNacional_2015-2020.xlsx")
...
```{r}
multi.hist(x = sonoraMango[-c(1,2,5,7,8,10,11)], dcol = c("blue", "red"), dlty = c("dotted", "solid"), main = "")
```

Explicación

```{r}
ggpairs(sonoraMango[-c(1)], lower = list(continuous = "smooth"),
